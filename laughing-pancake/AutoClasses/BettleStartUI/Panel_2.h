#ifndef __CCBETTLESTARTUI_PANEL_2_PANEL_2_H__
#define __CCBETTLESTARTUI_PANEL_2_PANEL_2_H__
#include "cocos2d.h"
...
public:
	...
	cocos2d::ui::Button*  m_BtCancel;
	cocos2d::ui::ImageView * m_Image_14_0;
	cocos2d::ui::ImageView * m_Image_14_0_0;
	cocos2d::ui::ImageView * m_Image_11;
	cocos2d::ui::Text * m_Text_1;
	cocos2d::ui::Text * m_Text_3;
cocos2d::Node * root;
};
}
#endif // __CCBETTLESTARTUI_PANEL_2_H__